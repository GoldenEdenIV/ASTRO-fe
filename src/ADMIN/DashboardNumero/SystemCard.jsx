      ...
      <div className="flex justify-between items-start mb-4">
        <div>
          ...
          <div className="flex gap-2 items-center">
            <span className="text-sm font-medium text-white">Formula:</span>
            <span className="text-sm text-gray-400">{system.formula}</span>
          </div>
        </div>
        <div className="flex gap-4 items-center">
          ...
          <ToggleSwitch
            ...
            onChange={(isActive) => onToggleActive(system.id, isActive)}
          />
        </div>
      </div>
    </article>
